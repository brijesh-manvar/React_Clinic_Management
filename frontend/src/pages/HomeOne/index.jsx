      ...
      <div className="bg-white-A700 flex flex-col font-inter items-center justify-end mx-auto w-full">
        <div className="flex flex-col items-start justify-end w-full">
          ...
          <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start md:ml-[0] ml-[26px] mt-[17px] md:px-5 w-[91%] md:w-full">
            ...
            <Text
              className="common-pointer md:ml-[0] ml-[489px] md:mt-0 mt-[9px] text-[15px] text-light_blue-700"
            ...
            <Text
              className="common-pointer md:ml-[0] ml-[33px] md:mt-0 mt-2.5 text-[15px] text-light_blue-700"
              size="txtInterSemiBold15"
            ...
            <Text
              className="common-pointer ml-8 md:ml-[0] md:mt-0 mt-2 text-[15px] text-light_blue-700"
              size="txtInterSemiBold15"
            ...
            <Text
              className="common-pointer md:ml-[0] ml-[31px] md:mt-0 mt-[9px] text-[15px] text-light_blue-700"
              size="txtInterSemiBold15"
              onClick={() => navigate("/docdetail")}
            >
              Doctor
            </Text>
            <a className="md:ml-[0] ml-[21px] md:mt-0 mt-2.5 text-[15px] text-light_blue-700">
              <Text
            ...
            <a className="md:ml-[0] ml-[35px] md:mt-0 mt-2.5 text-[15px] text-light_blue-700">
              <Text
                className="common-pointer"
                size="txtInterSemiBold15"
          ...
          <div className="h-[677px] md:h-[688px] sm:h-[838px] mt-3.5 md:px-5 relative w-full">
            <Img
              className="absolute h-[674px] inset-[0] justify-center m-auto object-cover w-full"
              src="images/img_whatsappimage20240129.png"
              alt="whatsappimageTwenty"
            />
            <div className="absolute bg-indigo-900_cc flex flex-col h-max inset-[0] items-center justify-center m-auto p-[35px] sm:px-5 w-full">
              <div className="flex flex-col gap-3 items-center justify-start my-[234px] w-[99%] md:w-full">
                <Text
                ...
                <div className="flex sm:flex-col flex-row sm:gap-5 items-start justify-start w-full">
                  <Img
                    className="common-pointer sm:flex-1 h-[63px] md:h-auto object-cover w-[5%] sm:w-full"
                    src="images/img_back.png"
                    alt="back"
                    onClick={() => navigate("/hometwo")}
                  />
                  <Text
                    className="sm:ml-[0] ml-[289px] md:text-5xl text-[64px] text-white-A700"
                    size="txtInterBlack64"
                  >
                    Clinic Management
                  </Text>
                  <Img
                    className="common-pointer sm:flex-1 h-[63px] md:h-auto sm:ml-[0] ml-[268px] object-cover w-[5%] sm:w-full"
