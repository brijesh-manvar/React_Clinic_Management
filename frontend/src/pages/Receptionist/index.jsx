...
const ReceptionistPage = () => {
  ...
  const handleRegisterClick = () => {
    const isConfirmed = window.confirm("Receptionist Data added Succesfully");
    if (isConfirmed) {
      ...
      <div className="bg-white-A700 flex flex-col font-inter items-center justify-start mx-auto w-full">
        <div className="flex flex-col items-center justify-start w-full">
          ...
          <div className="flex sm:flex-col flex-row sm:gap-5 items-start justify-start max-w-[1337px] mt-[17px] mx-auto md:px-5 w-full">
            ...
            <Text
              className="common-pointer sm:ml-[0] ml-[489px] sm:mt-0 mt-2 text-[15px] text-light_blue-700"
            ...
            <Text
              className="sm:ml-[0] ml-[33px] sm:mt-0 mt-[9px] text-[15px] text-light_blue-700"
              size="txtInterSemiBold15"
            >
              Receptionist
            </Text>
            <Text
              className="common-pointer ml-8 sm:ml-[0] sm:mt-0 mt-[7px] text-[15px] text-light_blue-700"
              size="txtInterSemiBold15"
            ...
            <Text
              className="common-pointer sm:ml-[0] ml-[31px] sm:mt-0 mt-2 text-[15px] text-light_blue-700"
              size="txtInterSemiBold15"
              onClick={() => navigate("/docdetail")}
            >
              Doctor
            </Text>
            <a className="sm:ml-[0] ml-[21px] sm:mt-0 mt-[9px] text-[15px] text-light_blue-700">
              <Text
            ...
            <a className="sm:ml-[0] ml-[35px] sm:mt-0 mt-[9px] text-[15px] text-light_blue-700">
              <Text
                className="common-pointer"
                size="txtInterSemiBold15"
            ...
            <a className="ml-8 sm:ml-[0] sm:mt-0 mt-[9px] text-[15px] text-light_blue-700">
              <Text
                className="common-pointer"
                size="txtInterSemiBold15"
                onClick={() => navigate("/login")}
          ...
          <div className="h-[659px] md:h-[673px] mt-3.5 md:px-5 relative w-full">
            ...
            <div className="absolute flex flex-col gap-[21px] justify-start left-[7%] top-[4%] w-[22%]">
              <Text
                className="md:ml-[0] ml-[45px] text-white-A700 text-xl"
                size="txtInterExtraBold20WhiteA700"
              >
