...
const PrecriptionPage = () => {
  ...
  const handleRegisterClick = () => {
    const isConfirmed = window.confirm("Prescription added Succesfully");
    if (isConfirmed) {
    ...
    <>
      <div className="bg-white-A700 flex flex-col font-inter items-center justify-start mx-auto w-full">
        <div className="flex flex-col gap-[17px] items-center justify-start w-full">
          ...
          <div className="flex sm:flex-col flex-row sm:gap-5 items-center justify-start max-w-[1337px] mx-auto md:px-5 w-full">
            <Img
            ...
            >
              <Text size="txtInterSemiBold15">Logout</Text>
            </a>
          </div>
          <div className="h-[659px] md:px-5 relative w-full">
            <Img
              className="h-[659px] m-auto object-cover w-full"
              src="images/img_pre11.png"
              alt="preEleven"
            />
            ...
            <div className="absolute bg-blue-300_68 border border-blue-300_7a border-solid bottom-[14%] h-[34px] left-[0] w-[44%]"></div>
            <Button className="absolute border border-blue-300_7a border-solid bottom-[19%] cursor-pointer font-semibold leading-[normal] left-[0] min-w-[604px] md:min-w-full text-[15px] text-center">
              Grid View
            </Button>
            <div className="absolute flex flex-col gap-[21px] justify-start left-[7%] top-[3%] w-[22%]">
              <Text
...
export default PrecriptionPage;
